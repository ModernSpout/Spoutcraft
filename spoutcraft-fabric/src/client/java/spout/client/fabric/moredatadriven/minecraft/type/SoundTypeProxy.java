...
/**
 * A proxy enum for {@link SoundType}.
 */
public enum SoundTypeProxy implements ProxyCodec.Proxy<SoundType> {
    ...
    COPPER_GOLEM_STATUE(SoundType.COPPER_GOLEM_STATUE),
    CAVE_VINES(SoundType.CAVE_VINES),
    SPORE_BLOSSOM(SoundType.SPORE_BLOSSOM),
    CACTUS_FLOWER(SoundType.CACTUS_FLOWER),
    ...
    LEAF_LITTER(SoundType.LEAF_LITTER),
    MOSS(SoundType.MOSS),
    ...
    VAULT(SoundType.VAULT),
    CREAKING_HEART(SoundType.CREAKING_HEART),
    HEAVY_CORE(SoundType.HEAVY_CORE),
    COBWEB(SoundType.COBWEB),
    SPAWNER(SoundType.SPAWNER),
    RESIN(SoundType.RESIN),
    RESIN_BRICKS(SoundType.RESIN_BRICKS),
    IRON(SoundType.IRON),
    DRIED_GHAST(SoundType.DRIED_GHAST);

    private final SoundType original;

    SoundTypeProxy(SoundType original) {
        this.original = original;
    }

    @Override
    public SoundType getOriginal() {
